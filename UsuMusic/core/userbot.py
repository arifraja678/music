...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("GalleryUsu")               
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(config.LOG_GROUP_ID, "Assistant ON")
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("GalleryUsu")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("GalleryUsu")
            except:
                pass
            assistants.append(3)
            try:
                await self.three.send_message(config.LOG_GROUP_ID, "Assistant ON")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("GalleryUsu")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("GalleryUsu")
            except:
                pass
            assistants.append(5)
            try:
