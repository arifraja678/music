...
from UsuMusic import LOGGER, YouTube, app
...
from UsuMusic.utils.inline.play import stream_markup
from UsuMusic.utils.stream.autoclear import auto_clean
from UsuMusic.utils.formatters import check_duration, seconds_to_min, speed_converter
...
class Call(PyTgCalls):
    ...
    async def start(self):
        LOGGER(__name__).info("Starting PyTgCalls==2.0.2 Client...\n")
        if config.STRING1:
