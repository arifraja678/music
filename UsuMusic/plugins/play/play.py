...
from UsuMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from UsuMusic.core.call import Usu
from UsuMusic.utils import seconds_to_min, time_to_seconds
from UsuMusic.utils.channelplay import get_channeplayCB
from UsuMusic.utils.database import is_video_allowed
from UsuMusic.utils.decorators.language import languageCB
from UsuMusic.utils.decorators.play import PlayWrapper
from UsuMusic.utils.formatters import formats
from UsuMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from UsuMusic.utils.inline.playlist import botplaylist_markup
...
@app.on_callback_query(filters.regex("UsuPlaylists") & ~BANNED_USERS)
@languageCB
