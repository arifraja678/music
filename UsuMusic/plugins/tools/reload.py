...
from UsuMusic.utils.database import get_authuser_names, get_cmode
from UsuMusic.utils.decorators import ActualAdminCB, AdminActual, language
from UsuMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Usu.stop_stream(message.chat.id)
    except:
        pass
